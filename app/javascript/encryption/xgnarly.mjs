...
function Ab3(e) {
  if (e && "undefined" != typeof Symbol && null != e[Symbol.iterator] || null != e["@@iterator"]) return Array.from(e);
}
...
function encode({queryString, body, userAgent, envcode}) {
  let obj = {};
  obj[1] = 1;
  obj[2] = 0;
...
/**
 * Generates X-Gnarly parameter for TikTok requests
 * @param {string} queryString - The URL query string
 * @param {string} bodyString - The request body as string
 * @param {string} userAgent - Browser user agent string
 * @param {number} version - Version number (not used, kept for compatibility)
 * @param {string} envcode - Environment code (typically "5.1.1")
 * @returns {string} X-Gnarly parameter value
 */
export default function signGnarly(queryString, bodyString, userAgent, version, envcode) {
  return encode({
    queryString: queryString,
    body: bodyString || "",
    userAgent: userAgent,
    envcode: envcode || "5.1.1"
  });
}
